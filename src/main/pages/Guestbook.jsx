          ...
          <div className="draw-modal-ft">
            <div style={{ display:"flex", gap:6, alignItems:"center", flexWrap:"wrap" }}>
              ...
              <button onClick={toggleErase}
                className="font-alkhemikal text-[7px] tracking-[0.15em] uppercase px-2 py-1 rounded-[2px] border"
                style={{
        ...
        <div className="flex-1 flex flex-col px-10 py-8 max-w-[640px] w-full">
          ...
          <div className="mt-6 flex flex-col gap-4 p-5 border rounded-[2px] mb-8"
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={label} className="flex flex-col gap-1">
                  <label className="font-alkhemikal text-[10px] tracking-[0.2em] uppercase" style={{ color:"var(--text-nav-inactive)" }}>
            ...
            <div className="flex flex-col gap-1">
              <label className="font-alkhemikal text-[10px] tracking-[0.2em] uppercase" style={{ color:"var(--text-nav-inactive)" }}>message</label>
            ...
            {availTags.length > 0 && (
              <div className="flex flex-col gap-2">
                <label className="font-alkhemikal text-[10px] tracking-[0.2em] uppercase" style={{ color:"var(--text-nav-inactive)" }}>tags</label>
            ...
            {/* drawing + submit row */}
            <div className="flex flex-col gap-2">
              <label className="font-alkhemikal text-[10px] tracking-[0.2em] uppercase" style={{ color:"var(--text-nav-inactive)" }}>draw something</label>
              ...
              {drawing ? (
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <button onClick={() => setShowDraw(true)} className="font-alkhemikal text-[10px] tracking-[0.2em] uppercase"
                      style={{ color:"var(--pink-text)", background:"none", border:"none", cursor:"pointer", textAlign:"left" }}>redraw</button>
                    <button onClick={() => setDrawing(null)} className="font-alkhemikal text-[10px] tracking-[0.2em] uppercase"
